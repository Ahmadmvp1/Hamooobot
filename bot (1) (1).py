...
# ======================
BOT_TOKEN = "7636445770:AAFid8YANrmTPzXIajQB-9T5J9ckXi0SRrI" 
CHAT_IDS = ["-1002517739980"]
DB_PATH = "bot.db"
...
IVASMS_ACCOUNTS = [
    {
        ...
        "username": "bwdyalwkyl78@gmail.com",  # غير حسب حسابك الأول
        "password": "##01018145430##",  # غير حسب حسابك الأول
    ...
    },
    {
        ...
        "base_url": "https://ivas.tempnum.qzz.io",
        "sms_api_endpoint": "https://ivas.tempnum.qzz.io/portal/sms/received/getsms",
        "username": "bwdyalwkyl78@gmail.com",  # ضع حسابك الثاني
        "password": "##01018145430##",  # ضع كلمة المرور الثانية
        "session": requests.Session(),
        "is_logged_in": False,
        "cookies": None,
        "csrf_token": None,
    ...
    },
    {
        ...
        "base_url": "https://ivas.tempnum.qzz.io",
        "sms_api_endpoint": "https://ivas.tempnum.qzz.io/portal/sms/received/getsms",
        "username": "bwdyalwkyl78@gmail.com",  # ضع حسابك الثالث
        "password": "##01018145430##",  # ضع كلمة المرور الثالثة
        "session": requests.Session(),
        "is_logged_in": False,
        "cookies": None,
        "csrf_token": None,
...
TIMESMS_ACCOUNTS = [
    ...
    },
    {
        ...
        "password": "BODY200HH",  # ضع كلمة المرور الثانية
        "session": requests.Session(),
        "is_logged_in": False,
        "cookies": None,
        "last_check": None,
    ...
    },
    {
        ...
        "password": "BODY200HH",  # ضع كلمة المرور الثالثة
        "session": requests.Session(),
        "is_logged_in": False,
        "cookies": None,
        "last_check": None,
...
def init_db():
    ...
    default_admins = [8456837947, 8456837947]
    ...
    try:
        keyboard = {
            "inline_keyboard": [
                ...
                [
                    {"text": "💬𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝟏", "url": "https://t.me/X_3GR_11", "style": "success"},
                    {"text": "💬𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝟐", "url": "https://t.me/BODY_YOUTYBER_20", "style": "success"}
                ],
                
                # الصف الثالث: زر المطور (أحمر - danger)
                [
                    {"text": "🤖𝘽𝙊𝙏 𝗡𝗨𝗠𝗕𝗘𝗥", "url": "http://t.me/NUMBERS_BODY_OTP_1_BOT", "style": "danger"},
                    {"text": "💬𝖣𝖤𝖵", "url": "https://t.me/X_3GR", "style": "danger"}
                ]
            ]
        }
    except Exception as e:
...
def send_otp_to_user_and_group(date_str, number, sms, account_name):
    ...
    if user_id:
        try:
            ...
            markup.row(
                types.InlineKeyboardButton("𝑂𝑊𝑁𝐸𝑅⚙️", url="https://t.me/X_3GR"),
                types.InlineKeyboardButton("💬𝐎𝐓𝐏 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/BODY_YOUTYBER_20")
            )
            bot.send_message(
                user_id,
...
def send_welcome(message):
    ...
    fancy_text = (
        "<b>❍<u>𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝗕𝗢𝗧 𝐂𝐑 𝐍𝐔𝐌𝐁𝐄𝐑</u>❍</b>\n\n"
        "<b>🔋 <u>𝐅𝐚𝐬𝐭  • 𝐒𝐞𝐜𝐮𝐫𝐞  • 𝐨𝐧𝐥𝐢𝐧𝐞</u></b>\n\n"
        "<b>🎓 <u>𝐎𝐖𝐍𝐄𝐑</u>  • <a>𝗕𝗢𝗗𝗬 𝗘𝗟 𝗬𝗢𝗨𝗧𝗨𝗕𝗘𝗥</a></b>\n\n"
        "<b>────────────────────</b>\n"
...
def handle_country_selection(call):
    ...
    # زر الجروب
    markup.add(types.InlineKeyboardButton("👁️𝐎𝐓𝐏 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/BODY_YOUTYBER_20"))
